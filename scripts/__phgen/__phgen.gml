...
function phgen_cache_remove_sprite(_sprite_index)
{
	...
	var _keys_array = ds_map_keys_to_array(global.__phgen_sprite_cache);
	var _found_key = undefined;
	for(var i = 0; i < array_length(_keys_array); i++)
	{
		if(ds_map_find_value(global.__phgen_sprite_cache, _keys_array[i]) == _sprite_index)
		{
			_found_key = _keys_array[i];
			break;
		}
	}
...
function phgen_cache_remove_string(_string)
{
	...
	var _keys_array = ds_map_keys_to_array(global.__phgen_string_cache);
	var _found_key = undefined;
	for(var i = 0; i < array_length(_keys_array); i++)
	{
		if(ds_map_find_value(global.__phgen_string_cache, _keys_array[i]) == _string)
		{
			_found_key = _keys_array[i];
			break;
		}
...
function phgen_cache_clear()
{
	...
	for(var i = 0; i < array_length(_keys_array); i++)
	{
		sprite_delete(ds_map_find_value(global.__phgen_sprite_cache, _keys_array[i]));
	}
